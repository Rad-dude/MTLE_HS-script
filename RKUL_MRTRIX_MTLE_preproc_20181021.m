...
% and 5ttgen)
% v 1.8 added antsCorticalThickness.sh to the workflow
...
dir_ants_CTh = [dir_main filesep 'NII' filesep 'T1s' filesep 'ants_CTh'];
...
for i = 1:(size(T1s_files,1))
    ...
    subj_ants_CTh_output = ([T1_base_name '_antsCTh_']);
    ...
    unix(['antsCorticalThickness.sh -d 3 -a ' dir_bc_t1 filesep T1_subj_bc ' -e ' T1_template ' -m ' T1_temp_brain_mask ...
        ' -p ' dir_templates filesep 'antsCTh_PD25_priors_0%d.nii.gz -g 1 -q 1 -o ' dir_ants_CTh filesep subj_ants_CTh_output]);
...
%     Initial variables
    ...
    % Do the whole brain probabilistic Tensor tracking with 2 mill fibers
    ...
    % connectome2tck find the fiber bundle of interest.
        ...
        unix(['antsRegistrationSyNQuick.sh -d 3 -m ' aal_template_brain ...
        ' -f ' dir_DTI_pping filesep DTI_T1_6 ' -o ' ...
        dir_DTI_pping filesep 'MNI1_brain_2_' DTI_sub_base 'brain  -x ' ...
        dir_DTI_pping filesep DTI_T1_6_mask ' -n 7 -j 1 -t s']);
        unix(['antsRegistrationSyNQuick.sh -d 3 -m ' T1_template_brain ... % there was a typo here, now it should be okay 5/10/2018 R
        ' -f ' dir_DTI_pping filesep DTI_T1_6 ' -o ' ...
        dir_DTI_pping filesep 'PD25_brain_2_' DTI_sub_base 'brain  -x ' ...
        dir_DTI_pping filesep DTI_T1_6_mask ' -n 7 -j 1 -t s']);
        unix(['WarpImageMultiTransform 3 ' aal_labels ' ' dir_DTI_ready filesep  aal_in_subj_DTI ...
        ' -R ' dir_DTI_pping filesep DTI_T1_6 ' ' ...
        dir_DTI_pping filesep 'MNI1_brain_2_' DTI_sub_base 'brain1Warp.nii.gz ' dir_DTI_pping filesep 'MNI1_brain_2_' DTI_sub_base 'brain0GenericAffine.mat --use-NN']);
        unix(['WarpImageMultiTransform 3 ' BN_246_3D_labels ' ' dir_DTI_ready filesep BN246_in_subj_DTI ...
        ' -R ' dir_DTI_pping filesep DTI_T1_6 ' ' ...
        dir_DTI_pping filesep 'PD25_brain_2_' DTI_sub_base 'brain1Warp.nii.gz ' dir_DTI_pping filesep 'PD25_brain_2_' DTI_sub_base 'brain0GenericAffine.mat --use-NN']);
